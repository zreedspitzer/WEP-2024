# Purpose: Calculating Census data Weighted Average for New SB's as of 1/13
# Created: 1/13/23
...
#importing data
cens_2010 <- read_xlsx("CensusData_NewSB.xlsx", 
                       sheet = "2010")
cens_2011 <- read_xlsx("CensusData_NewSB.xlsx", 
                       sheet = "2011")
cens_2012 <- read_xlsx("CensusData_NewSB.xlsx", 
                       sheet = "2012")
cens_2013 <- read_xlsx("CensusData_NewSB.xlsx", 
                       sheet = "2013")
cens_2014 <- read_xlsx("CensusData_NewSB.xlsx", 
                       sheet = "2014")
cens_2015 <- read_xlsx("CensusData_NewSB.xlsx", 
                       sheet = "2015")
cens_2016 <- read_xlsx("CensusData_NewSB.xlsx", 
                       sheet = "2016")
cens_2017 <- read_xlsx("CensusData_NewSB.xlsx", 
                       sheet = "2017")
cens_2018 <- read_xlsx("CensusData_NewSB.xlsx", 
                       sheet = "2018")
cens_2019 <- read_xlsx("CensusData_NewSB.xlsx", 
                       sheet = "2019")
cens_2020 <- read_xlsx("CensusData_NewSB.xlsx", 
                       sheet = "2020")
cens_2021 <- read_xlsx("CensusData_NewSB.xlsx", 
                       sheet = "2021")
...
#exporting df_cens
write_xlsx(df_cens,"AggregateCensusData_NewSB_113.xlsx")
