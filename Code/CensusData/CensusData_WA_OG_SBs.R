# Purpose: Calculating Census data Weighted Average up to Subbasin level 
# Created: 10/13/23
# Purpose: WEP Revisions
# Author: Zoey Reed-Spitzer

# ---- Setup ---- 
setwd("C:/Users/zoeys/Documents/Data/Census Data")
...
#importing data
cens_2010 <- read_xlsx("CensusData_OG_SBs.xlsx", 
                          sheet = "2010")
cens_2011 <- read_xlsx("CensusData_OG_SBs.xlsx", 
                       sheet = "2011")
cens_2012 <- read_xlsx("CensusData_OG_SBs.xlsx", 
                       sheet = "2012")
cens_2013 <- read_xlsx("CensusData_OG_SBs.xlsx", 
                       sheet = "2013")
cens_2014 <- read_xlsx("CensusData_OG_SBs.xlsx", 
                       sheet = "2014")
cens_2015 <- read_xlsx("CensusData_OG_SBs.xlsx", 
                       sheet = "2015")
cens_2016 <- read_xlsx("CensusData_OG_SBs.xlsx", 
                       sheet = "2016")
cens_2017 <- read_xlsx("CensusData_OG_SBs.xlsx", 
                       sheet = "2017")
cens_2018 <- read_xlsx("CensusData_OG_SBs.xlsx", 
                       sheet = "2018")
cens_2019 <- read_xlsx("CensusData_OG_SBs.xlsx", 
                       sheet = "2019")
cens_2020 <- read_xlsx("CensusData_OG_SBs.xlsx", 
                       sheet = "2020")
cens_2021 <- read_xlsx("CensusData_OG_SBs.xlsx", 
                       sheet = "2021")
...
# ---- Fixing Per Capita Income Variable ----
#importing per cap inc for each year
pci_2010 <- read_xlsx("PerCapIncome.xlsx", 
                      sheet = "2010b")
pci_2011 <- read_xlsx("PerCapIncome.xlsx", 
                      sheet = "2011b")
pci_2012 <- read_xlsx("PerCapIncome.xlsx", 
                      sheet = "2012b")
pci_2013 <- read_xlsx("PerCapIncome.xlsx", 
                      sheet = "2013b")
pci_2014 <- read_xlsx("PerCapIncome.xlsx", 
                      sheet = "2014b")
pci_2015 <- read_xlsx("PerCapIncome.xlsx", 
                      sheet = "2015b")
pci_2016 <- read_xlsx("PerCapIncome.xlsx", 
                      sheet = "2016b")
pci_2017 <- read_xlsx("PerCapIncome.xlsx", 
                      sheet = "2017b")
pci_2018 <- read_xlsx("PerCapIncome.xlsx", 
                      sheet = "2018b")
pci_2019 <- read_xlsx("PerCapIncome.xlsx", 
                      sheet = "2019b")
pci_2020 <- read_xlsx("PerCapIncome.xlsx", 
                      sheet = "2020b")
pci_2021 <- read_xlsx("PerCapIncome.xlsx", 
                      sheet = "2021b")
...
wa_2010 <- cens_2010 %>%
  group_by(Subbasin) %>%
  summarise(wa_Median_Income = weighted.mean(Median.Income.HH, 
                                             w = Total.Households),
            wa_Mean_Income = weighted.mean(Mean.Income.HH, 
                                           w = Total.Households),
            wa_Per_Capita_Income = weighted.mean(Per.Capita.Income, 
                                                 w = Population),
            avg_Housing_Units = mean(Housing.Units),
            wa_Count_Below_Poverty = weighted.mean(Count.Below.Poverty.P, 
                                                   w = Population),
  )
...
#exporting data set
write_xlsx(df_cens, "censusData_OG_SBs_WA.xlsx")
